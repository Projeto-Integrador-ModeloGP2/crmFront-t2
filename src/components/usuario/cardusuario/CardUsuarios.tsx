    ...
    >
      <div>
        ...
        <div className="p-9 ">
          ...
          <p>
            {" "}
            <strong>E-mail: </strong> {usuarios.usuario}
          </p>
          <p>
            {" "}
            <strong>Plano: </strong>
            {usuarios.plano?.length
              ? usuarios.plano.map((plano) => plano.nome).join(", ")
              : "Sem plano"}
          </p>
        </div>
      </div>
